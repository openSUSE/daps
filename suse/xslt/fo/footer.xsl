...
<xsl:template match="title" mode="footer">
   ...
   <xsl:param name="title">
     <xsl:choose>
       <xsl:when test="ancestor-or-self::book/bookinfo/title">
         <xsl:apply-templates
          select="ancestor-or-self::book/bookinfo/title" mode="footer"/>
       </xsl:when>
       <xsl:when test="ancestor-or-self::info/title">
         <xsl:apply-templates select="ancestor-or-self::book/info/title" mode="footer"/>
       </xsl:when>
...
-->
   ...
   <fo:inline margin-left="10pt"  border="0.8pt solid red"
...
<xsl:template name="footer.rightside">
 <xsl:variable name="title">
  ...
  <fo:inline text-align="right"  margin-right="10pt"  border="0.8pt solid red"
