...
all: catalogs/CATALOG.$(DTDNAME)-$(DTDVERSION) manuals manpages
all: xhtml2html
...
.PHONY: clean
clean:
	rm -rf catalogs/ schema/novdocx.rnc schema/novdocx.rng man/build/ doc/build/ suse-xslt/html/
...
.PHONY: manpages
manpages:
	bin/daps --debug --dtdroot=$(shell pwd) --basedir=$(shell pwd)/man \
